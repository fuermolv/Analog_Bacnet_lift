...
{    
    ...
    {
        public static int Decode_Unsigned32(ref byte[] apdu, ref UInt32 value, int pos = 0)
        {
            if (value != null)
            {
        ...
        public static int Decode_Unsigned16(ref byte[] apdu, ref UInt16 value, int pos = 0)
        {
            if (value != null)
            {
        ...
        public static int Decode_Unsigned24(ref byte[] apdu, ref UInt32 value, int pos = 0)
        {
            if (value != null)
            {
        ...
        public static Boolean Decode_Boolean(UInt32 len_value)
        {
        ...
        public static Boolean Decode_Context_Boolean(ref Byte[] apdu,int pos)
        {
            bool boolean_value = false;
        ...
        public static int Decode_Tag_number_and_Value(ref byte[] apdu, ref byte tag_number, ref UInt32 value, int pos)
        {
            int len = 1;
        ...
        public static int Decode_Tag_Number(ref byte[] apdu, ref byte tag_number, int pos = 0)
        {
            int len = 1;
        ...
        public static int Decode_Unsigned(ref byte[] apdu, UInt32 len_value, ref UInt32 value, int pos)
        {
        ...
        public static int Decode_Max_Segs(ref Byte[] buf,int pos)
        {
            int max_segs = 0;
       ...
       public static int Decode_Max_Apdu(ref Byte[] buf,int pos)
        {
            int max_apdu = 0;
        ...
        public static int Decode_Object_Id(ref Byte[]apdu,ref UInt16 object_type,ref UInt32 instance,int pos)
       {
           UInt32 value = 0;
           int len = 0;
        ...
        public static int Decode_Context_Enumerated(ref Byte[] apdu,Byte tag_value,ref UInt32 value,int pos)
        {
            int len = 0;
            Byte tag_number=0;
            UInt32 len_value=0;
        ...
        public static int Decode_Enumerated(ref Byte[] apdu, UInt32 len_value,ref UInt32 value,int pos )
        {
        ...
        public static int Decode_Data(ref Byte[] apdu, Byte tag_data_type, UInt32 len_value_type,ref BACNET_APPLICATION_DATA_VALUE value,int pos)
        {
         ...
         public static Boolean Decode_Is_Closing_Tag_Number(ref Byte[] apdu,Byte tag_number,int pos)
        {
             Byte my_tag=0;
             Decode_Tag_Number(ref apdu, ref my_tag, pos);
             return ((apdu[pos] & 0x07) == 7) && (my_tag == tag_number);
        }
        public static Boolean Decode_Is_Context_Tag(ref Byte[] apdu,Byte tag_number,int pos)
         {
             Byte my_tag = 0;
             Decode_Tag_Number(ref apdu, ref my_tag, pos);
             return ((apdu[pos] & 0x08) == 0x08) && (my_tag == tag_number);
         }
        public static Boolean Decode_Is_Opening_Tag_Number(ref Byte[] apdu, Byte tag_number, int pos)
        {
            Byte my_tag = 0;
            Decode_Tag_Number(ref apdu, ref my_tag, pos);
       ...
       public static int Decode_Context_Unsigned(ref Byte[] apdu,Byte tag_number,ref UInt32 value,int pos)
        {
            UInt32 len_value=0;
            int len = 0;
            len += Decode_Tag_number_and_Value(ref apdu, ref tag_number, ref len_value, pos + len);
        ...
        public static int Decode_Datetime(ref Byte[] apdu,ref BACNET_DATE_TIME value,int pos )
       {
        ...
        public static int Decode_Application_Date(ref Byte[] apdu,ref  BACNET_DATE bdate,int pos)
        {
            int len = 0;
            Byte tag_number=0;
        ...
        public static int Decode_Date(ref Byte[] apdu, ref BACNET_DATE bdate, int pos)
        {
        ...
        public static int Decode_Signed(ref Byte[] apdu,UInt32 len_value,ref Int32 value,int pos)
          {
            //未完成
             return (int)len_value;
          }
        ...
        public static int Encode_Unsigned(ref byte[] apdu,UInt32 value,int pos)
        {
            int len = 0;
            if (value < 0x100)
            {
        ...
        public static int Encode_Tag(ref byte[] apdu, byte tag_number, bool context_specific, UInt32 len_value_type, int pos)
        {
        ...
        public static int Encode_Unsigned16(ref byte[] apdu, UInt16 value, int pos)
        {
        ...
        public static int Encode_Unsigned24(ref byte[] apdu, UInt32 value,int pos)
        {
    ...
    return 3;
      ...
      public static int Encode_Unsigned32(ref byte[] apdu, UInt32 value, int pos)
        {
        ...
        public static Byte Encode_MaxSegsandApdu(
       int max_segs,
       int max_apdu)
        {
            Byte octet = 0;
        ...
        public static int Encode_Context_ObjectId(ref Byte[] apdu, Byte tag_number, int object_type, UInt32 instance,int pos)
        {
            int len = 0;
            UInt32 value = 0;
            UInt32 type = 0;
     ...
     public static int Encode_Context_Enumerate(ref Byte[] apdu,Byte tag_number,UInt32 value,int pos)
    {
        int len=0;
     ...
     public static int Encode_Context_Boolean(ref Byte[] apdu,Byte tag_number,Boolean value,int pos)
     {
         int len = 0;        /* return value */
    ...
    public static int Encode_Context_Unsigned(ref Byte[] apdu,Byte tag_number,UInt32 value,int pos)
     {
         int len = 0;
    ...
    public static int Encode_Opening_Tag(ref Byte[] apdu,Byte tag_number,int pos )
    {
        int len = 1;
    ...
    public static int Encode_Closing_Tag(ref Byte[] apdu,Byte tag_number,int pos)
    {
        int len = 1;
    ...
    public static int Encode_Application_Date(ref Byte[] apdu,ref BACNET_DATE bdate,int pos)
       {
           int len = 0;
        ...
        public static int Encode_Bitstring(ref Byte[] apdu,ref  BACNET_BIT_STRING bit_string,int pos)
    {
        ...
        public static int Encode_Context_Character_String(ref Byte[] apdu,Byte tag_number,ref BACNET_CHARACTER_STRING char_string,int pos)
      {
        ...
        public static int Encode_Application_Boolbean(ref Byte[] apdu,Boolean value,int pos)
        {
            int len = 0;
            UInt32 len_value = 0;
            if(value)
        ...
        public static int Encode_Application_Enumerated(ref Byte[] apdu,UInt32 value,int pos)
        {
            int len = 0;  
