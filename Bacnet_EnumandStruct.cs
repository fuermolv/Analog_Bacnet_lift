...
/*    public class BACnet_Date
   ...
   public struct BACNET_NPDU_DATA
    {
    ...
    public class ACKNOWLEDGE_ALARM_DATA
    {
        ...
        {
            Source = new BACNET_CHARACTER_STRING(5);
        }
    ...
    public class BACNET_ADDRESS
  {
   ...
   public byte[] mac ;
    ...
    public class BACNET_COV_SUBSCRIPTION
    {
    ...
    public class BACNET_PROPERTY_VALUE
    {
    ...
    public struct BACNET_CONFIRMED_SERVICE_DATA
  {
    ...
    public struct BACNET_SUBSCRIBE_COV_DATA
 {
     public UInt32 subscriberProcessIdentifier;
     public BACNET_OBJECT_ID monitoredObjectIdentifier;
    ...
    public struct BACNET_OBJECT_ID
{
    ...
    public class BACNET_PROPERTY_REFERENCE
    {
        BACNET_PROPERTY_ID propertyIdentifier;
        Int32 propertyArrayIndex;
        BACNET_APPLICATION_DATA_VALUE value;//这是一个链表

        BACNET_PROPERTY_REFERENCE next;
        public BACNET_PROPERTY_REFERENCE()
        {
            next = null;
        }
        public void add( BACNET_PROPERTY_REFERENCE section)
     {
         next = section;
     }
    }

    public class BACNET_APPLICATION_DATA_VALUE
    {
  ...
  public struct type
    ...
    public class BACNET_BIT_STRING
    ...
    public class BACNET_OCTET_STRING
    {
        public uint size;
        Byte[] value;
    ...
    public struct BACNET_CONFIRMED_SERVICE_ACK_DATA
  {
      public Boolean segmented_message;
      public Boolean more_follows;
      public Byte invoke_id;
    ...
    public class BACNET_EVENT_NOTIFICATION_DATA
    {
      ...
      {
         public CHANGE_OF_STATE change_of_state;
         public   Change_Of_LifeSafety change_of_lifesafety;
  ...
  public enum BACNET_OBJECT_TYPE
  {
    ...
    PROP_LIFT_Service_Mode=512,
    PROP_LIFT_Time_Stamps=513,
    PROP_LIFT_Car_Status=514,
    PROP_LIFT_Car_Direction=515,
    PROP_LIFT_Door_Zone=516,
    PROP_LIFT_Car_Position=517,
    PROP_LIFT_Door_Status=518,
    PROP_LIFT_Passenger_Status=519,
    PROP_LIFT_Total_Running_Time=520,
    PROP_LIFT_Present_Counter_Value=521,
    PROP_LIFT_Message_Code=522,
    PROP_LIFT_Device_Identifer=523
